...
struct Swift_Protobuf_TestFieldOrderings: IntentSwiftProtobuf.ExtensibleMessage {
...
struct Swift_Protobuf_OneofTraversalGeneration: IntentSwiftProtobuf.ExtensibleMessage {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
let Swift_Protobuf_UnittestSwiftFieldorder_Extensions: IntentSwiftProtobuf.SimpleExtensionMap = [
...
extension Swift_Protobuf_TestFieldOrderings: IntentSwiftProtobuf.Message, IntentSwiftProtobuf._MessageImplementationBase, IntentSwiftProtobuf._ProtoNameProviding {
...
extension Swift_Protobuf_TestFieldOrderings.NestedMessage: IntentSwiftProtobuf.Message, IntentSwiftProtobuf._MessageImplementationBase, IntentSwiftProtobuf._ProtoNameProviding {
...
extension Swift_Protobuf_OneofTraversalGeneration: IntentSwiftProtobuf.Message, IntentSwiftProtobuf._MessageImplementationBase, IntentSwiftProtobuf._ProtoNameProviding {
